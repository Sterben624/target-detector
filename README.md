...
**Частоти:**
- **UDP вхід: 44100 Hz** (рекомендовано для TDOA локалізації)
- **Детектор: автоматичний resample 44100 → 16000 Hz** (нейронка навчена на 16 kHz)
- TDOA використовує 44100 Hz для точності, детектор робить resample внутрішньо
